...
@summary:   Convert l_r_alpha_beta.txt to formats readable by cpp code
            
@inputs:    l_r_alpha_beta.txt (located in fnl_Planck/code/data/; created by 
            running fnl_Planck/alphabeta/compute_alphabeta)
...
@outputs:   Alpha, beta, ell, r, and dr files in formats readable by read_matrix
            function used in cl21_ana.cpp and kl_ana.cpp

            alpha_ell_[i_num_ell]_r_[i_num_r].txt
            beta_ell_[i_num_ell]_r_[i_num_r].txt
            ell_[i_num_ell].txt
            r_[i_num_r].txt
            dr_r_[i_num_r].txt
