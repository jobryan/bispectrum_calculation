...
vector<int> cart_index(long long int ll_index, vector<int> vi_dims){
...
/*    int i_max_size = 1;
    ...
    long long int ll_quotient = ll_index;
...
int main(int i_argc, char* s_argv[]){
    ...
    */
    ...
    if (i_rank == 0) {
        ...
        long long int ll_total_jobs = pow(i_num_l,3);
        long long int ll_cur_job = 0;
    ...
    //slave loop
        ...
        while (1) {
            ...
            MPI_Recv(&ll_job_index, 1, MPI_LONG_LONG_INT, 0, MPI_ANY_TAG, 
